:: setcdrmake.bat
::
:: Sets up variables for compiling CDR on my local machine.
...
rem set CDR=n:/cdr
rem set XML4C=n:/usr/xml4c
rem set SABLOT=n:/usr/sablot
rem set REGEX=n:/usr/regex
rem set BISON_SIMPLE=n:/etc/bison.cdrtest
