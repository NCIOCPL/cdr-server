...
/**@#+*/
    ...
    class CdrDoc {
        public:
            ...
            /**
             * Bump up the count of warnings generated by document validation.
             *
             *  @param   howMuch  count of warnings to be added to warning
             *                    count accumulator.
             */
            void incrementWarningCount(int howMuch = 1) {
                warningCount += howMuch;
            }

            /**
             * Access method for count of warning messages generated by
             * document validation.
             *
             ...
             * message.  Not used by older code, but as that code gets
             * rewritten, and as we add new validation code, we need
             * to use this newer mechanism.
             *
             *  @param   message   reference to string to be added to
             *                     list of validation error strings.
             *  @param   severity  one of the values enumerated just below.
             */
            enum WarningSeverity { VAL_MESSAGE_ERROR = 1,
                                   VAL_MESSAGE_WARNING = 2 };
            void addValidationMessage(const cdr::String& message,
                                      WarningSeverity severity =
                                      VAL_MESSAGE_ERROR) {
                errList.push_back(message);
        ...
        private:
            ...
            // Count of warnings generated by document validation.
            // Allows us to determine whether the presence of error
            // messages means that the document is invalid.
            int warningCount;
